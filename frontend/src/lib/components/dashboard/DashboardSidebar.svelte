...
<Sidebar bind:open>
  ...
  <SidebarGroup title="Settings" class="sm:hidden">
    <SidebarItem href="/dashboard/profile" onClick={close}>
      {#snippet icon()}
  ...
  {#if me?.roles?.includes("admin")}
    <SidebarGroup title="Admin">
      <SidebarItem href="/admin" icon={adminIcon} onClick={close}>Admin Panel</SidebarItem>
    </SidebarGroup>
  {/if}
</Sidebar>