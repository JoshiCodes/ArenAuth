<script lang="ts">
    ...
    onMount(async () => {
        ...
        apiCall("/oauth2/consent?req=" + req, {
            ...
            if(!data.project || !data.project.name || !data.scope || !data.redirectUri) {
            ...
            <div class="w-4/5 mx-auto my-4 pb-2 md:pb-4 dark:text-zinc-400 text-sm">
                <div class="mt-4 flex flex-col gap-y-2">
                    <div class="flex flex-row justify-start content-center items-center px-4 gap-x-2">
                        ...
                        <span>After you authorise, you will be redirected <b>outside Aren</b> to <b>{redirectUri}</b></span>
                    </div>
                </div>
                <div class="mt-4 flex flex-col gap-y-2">
                    <div class="flex flex-row justify-start content-center items-center px-4 gap-x-2">
                        ...
                        <span>Active since <b>idk</b></span>
                    </div>
                </div>
            </div>
        </div>
